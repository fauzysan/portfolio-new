...
const Hero = () => {
  ...
  return (
    ...
    <div className='flex lg:flex-row max-md:flex-col-reverse sm-md:text-center items-center justify-between font-sans h-screen w-full dark:bg-grid-white/[0.05] bg-grid-black/[0.2] max-md:mb-64'>
        ...
        <div className='mx-auto w-[450px] h-[480px] max-md:size-64 max-md:my-24'>
